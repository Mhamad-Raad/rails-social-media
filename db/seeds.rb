...
first_user = User.create( name: 'Tom', ImgUrl: 'https://images.unsplash.com/photo-1508921912186-1d1a45ebb3c1?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=387&q=80',
                    bio: 'Teacher from Mexico.')
second_user = User.create(  name: 'Lilly', ImgUrl: 'https://images.unsplash.com/photo-1665686310934-8fab52b3821b?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxzZWFyY2h8NXx8d29tYW58ZW58MHx8MHx8&auto=format&fit=crop&w=500&q=60',
                          bio: 'Teacher from Poland.')
User.create(name: 'Cindy', bio: 'The blog Creator',
